...
function readConfig() {
  ...
  return {
    ...
    openclawBaseUrl: readTextEnv("CYBERBOSS_OPENCLAW_BASE_URL") || "http://127.0.0.1:18789",
    openclawApiKey: readTextEnv("CYBERBOSS_OPENCLAW_API_KEY") || "openclaw123",
    openclawModel: readTextEnv("CYBERBOSS_OPENCLAW_MODEL") || "openclaw/default",
